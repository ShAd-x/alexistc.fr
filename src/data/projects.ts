...
export const projects: Project[] = [
  {
    ...
    tags: ["Full-Stack", "Web", "Gestion de projet", "Design", "Association"],
  ...
  },
  {
    ...
    tags: ["Full-Stack", "Web", "Gestion de projet", "Design", "Santé"],
    category: "Académique",
  },
  {
    id: "app-bancaire",
  ...
  },
  {
    ...
    description:
      "Développement full-stack avec Angular (frontend) + Node.js/Express (backend) + MongoDB. Gestion d’équipements.",
    technologies: ["Angular", "Node.js", "Express", "MongoDB", "Mongoose"],
    tags: ["Full-Stack", "Web", "NoSQL", "Authentification"],
    category: "Académique",
  ...
  },
  {
    ...
    technologies: ["Swift"],
    tags: ["Mobile", "MVVM", "Gestion du temps", "Productivité"],
    category: "Personnel",
    link: "https://github.com/ShAd-x/Bloctime",
  },
  {
    id: "luma",
    ...
    tags: ["Web", "Landing Page", "Design"],
    category: "Personnel",
    link: "https://github.com/ShAd-x/luma-demo",
  },
];
