...
export const experiences: TimelineItem[] = [
  {
    ...
    description:
      "Développement full-stack sur un e-commerce pharmaceutique en production (PHP legacy, ~1 160 commits). Passerelle de paiement bancaire (CAWL/Worldline), file de jobs asynchrones (workers exécutés par cron) et framework d'A/B testing server-side. En parallèle, refonte vers une architecture découplée : API GraphQL (Laravel, Octane) + front Blade (htmx).",
    skills: [
      "PHP 8",
      "MySQL / MariaDB",
      "E-commerce",
